...
public class test {
    ...
    public void test1() {
        ...
        for (Element descriptorRecord : descriptorRecords) {
            ...
            Element descriptorUI = XmlUtil.getElement(descriptorRecord, "DescriptorUI");//添加Id
            ...
            descriptorRecordModel.setId(descriptorUI.getTextContent());//添加Id
            ...
            for (Element concept : concepts) {
                ...
                Element conceptUI = XmlUtil.getElement(concept, "ConceptUI");
                ...
                conceptModel.setId(conceptUI.getTextContent());
                ...
                for (Element term : termEs) {
                    ...
                    Element termUI = XmlUtil.getElement(term, "TermUI");
                    termModel.setId(termUI.getTextContent());
